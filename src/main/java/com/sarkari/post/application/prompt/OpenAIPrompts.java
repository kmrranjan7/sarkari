...
public final class OpenAIPrompts {
    ...
    public static final String SYSTEM_POST_DRAFT_PROMPT = "You are an expert Sarkari job post writer. " +
            ...
            "Rules: postType must be one of Job|Admit|Exam|Result|Admission|Syllabus|Answer_Key; postStatus must be one of Draft|Pending Review|Scheduled|Published; qualification must be one of Below 10th Pass|10th Pass|12th Pass|Diploma|Graduate|Post Graduate; dates must be YYYY-MM-DD and scheduledAt must be YYYY-MM-DDTHH:mm or empty string; faqSchemaJson must be a JSON string; priorityScore must be 0..100.";
